 ...
 * default). System room lifecycle receipts and failures always show. So does a bot⇄bot comm chip: "Messaged
...
export function roomActivityVisible(message: Message, showToolCalls: boolean): boolean {
  ...
  return tool.system === true || tool.ok === false || tool.name.startsWith("error:") || showToolCalls;
}
